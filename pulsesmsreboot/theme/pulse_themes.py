from pulsesmsreboot.theme.style import buildTheme
...
class ZPallete():
    ...
    def setPath(self, path):
        self.path = pulsesmsreboot.abs_path + '/assets/icons/app/'+path

    def setPathBtnTitlebar(self, path):
        self.path_btn_titlebar = pulsesmsreboot.abs_path + \
