from pulsesmsreboot.controllers.main_window_components.builder_icon import getIconTray
from PyQt6.QtGui import QImage, QPixmap, QIcon
from PyQt6.QtCore import QSize
import pulsesmsreboot
import random

from pulsesmsreboot.theme.icons import ICON_DEFAULT, SVG_NOTIFICATION
...
def getIconDefaultURLNotification() -> str:
    try:
        ...
        path = pulsesmsreboot.path_tmp+'/com.snuggerdog.pulsesmsreboot.png'
        qpix.save(path)
        return path
