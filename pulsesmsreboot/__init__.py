...
__version__ = '1'
__appname__ = 'PulseSMSReboot'
__comment__ = 'Pulse SMS App for linux'
__domain__ = 'com.snuggerdog'
__desktopid__ = 'com.snuggerdog.pulsesmsreboot'
__appid__ = 'pulsesmsreboot-application'
...
__pulsesms_url__ = 'https://pulsesms.app'
...
DATABASE_FILE = os.path.join(DATABASE_DIR, 'pulsesms.db')
